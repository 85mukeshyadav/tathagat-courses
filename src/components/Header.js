                ...
                <div className="relative flex items-center justify-between h-16">
                    ...
                    <div className="flex-1 flex items-center sm:items-stretch sm:justify-start">
                        <Link style={ {} } to='/'>
                            <div className="flex-shrink-0 flex items-center">
                                <img className='w-fullimg h-10' src="https://www.tathagat.co.in/assets/img/logo.png"></img>
                            </div>
                        </Link>
                        <div className="hidden sm:block sm:ml-6">
                            <div className="flex space-x-4">
                                ...
                                <Link to={isAuth ? '/myCourses' : '/'} className="text-gray-100 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{isAuth ? 'My Courses' : ''}</Link>

                                    <Link to={isAuth ? '/courses' : '/'} className="text-gray-100 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">{isAuth ? 'All Courses' : ''}</Link>
                                {/* </Link> */}
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        {/* <Link style={ { padding: 6 } } to='signin' > */}
                            <Link to='signin' className="text-gray-100 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Login</Link>
                        {/* </Link> */}
                        {/* <Link style={ { padding: 6 } } to='signup' > */}
                            <Link to='signup' className="text-gray-100 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Signup</Link>
                        {/* </Link> */}
                        </> : null }
                        ...
                        { isAuth ? 
                                <Link style={{cursor:'pointer'}} onClick={()=>{
                                    ...
                                    }} to='/' className="text-gray-100 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium" role="menuitem" tabIndex="-1" id="user-menu-item-2">Sign out</Link>
                            : null }
                        {/* </div>
                        </div> */}
                    </div>
