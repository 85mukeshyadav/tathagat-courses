...
const TreeList = (props) => {
	...
	rawTreeData.courseList &&
		rawTreeData.courseList.map((res, i) => {
			let newJ = {
				key: count,
	...
	rawTreeData.courseTest &&
		rawTreeData.courseTest.map((res, i) => {
			let newJ = {
				key: count,
				label: res.TestTitle,
				icon: "fa fa-graduation-cap",
	...
	rawTreeData.subjectList &&
		rawTreeData.subjectList.map((res, i) => {
			let newJ = {
				key: subCount,
	...
	rawTreeData.subjectTest &&
		rawTreeData.subjectTest.map((res, i) => {
			let newJ = {
				key: subCount,
				label: res.TestTitle,
				icon: "fa fa-graduation-cap",
	...
	let chpCount = 0;
	rawTreeData.chapterList &&
		rawTreeData.chapterList.map((res, i) => {
			let newJ = {
				key: chpCount,
			...
			treeData[rawTreeData.index["courseIndex"]].children[
				rawTreeData.index["subjectIndex"]
			].children.push(newJ);
			chpCount = chpCount + 1;
		});
	...
	let topicCount = 0;
	rawTreeData.topicList &&
		rawTreeData.topicList.map((res, i) => {
			let newJ = {
				key: topicCount,
				label: res.topicName,
				icon: "fa fa fa-address-card-o",
			...
			treeData[rawTreeData.index["courseIndex"]].children[
				rawTreeData.index["subjectIndex"]
			].children[rawTreeData.index["chapterIndex"]].children.push(newJ);
			topicCount = topicCount + 1;
		});

	rawTreeData.topicTest &&
		rawTreeData.topicTest.map((res, i) => {
			let newJ = {
				key: topicCount,
				label: res.TestTitle,
				icon: "fa fa-graduation-cap",
			...
			treeData[rawTreeData.index["courseIndex"]].children[
				rawTreeData.index["subjectIndex"]
			].children[rawTreeData.index["chapterIndex"]].children[
				rawTreeData.index["topicIndex"]
			].children.push(newJ);
			topicCount = topicCount + 1;
		});
