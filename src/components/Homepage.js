...
import { FiArrowRight, FiBarChart, FiBarChart2, FiBook, FiFile, FiSearch, FiVideo } from 'react-icons/fi';
...
const Homepage = () => {
    ...
    const _getrandomPkg = async () => {
        ...
        console.log("🚀 ~ file: Homepage.js ~ line 21 ~ const_getrandomPkg= ~ res", res)
        setData(res.data)
    }
        ...
        <>
            <div className="relative flex flex-col lg:flex-row bg-white overflow-hidden p-2  ">
                        ...
                        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-18 lg:px-8 xl:mt-16">
                            <div className="sm:text-center lg:text-left">
                                <h1 className="text-4xl text-left tracking-tight font-extrabold text-gray-700 sm:text-5xl md:text-6xl">
                                    <span style={ { letterSpacing: 2 } } className="block xl:inline leading-8 "> One Destination for Complete </span>
                                    <span style={ { letterSpacing: 2 } } className="block text-indigo-600 xl:inline mt-2 leading-8">Exam Preparation</span>
                                </h1>
                                <p className="lg:mt-10 flex items-center text-base text-gray-500 mt-6 sm:text-lg sm:max-w-xl sm:mx-auto md:text-xl lg:mx-0">
                                    Learn <FiArrowRight className='text-indigo-500 md:ml-2 md:mr-2' /> Practice <FiArrowRight className='text-indigo-500 ml-2 mr-2' /> Improve <FiArrowRight className='text-indigo-500 ml-2 mr-2' /> Succeed
                                </p>
                                <div className="mt-10 lg:mt-10 sm:mt-8 relative sm:flex sm:justify-center w-full sm:w-full md:w-2/3 lg:justify-start">
                                    <input type='search' placeholder='Search your favourite course'
                ...
                <div className="relative lg:w-1/2 ">
                    <img className="h-56 w-full object-contain sm:h-72 md:h-96 lg:w-10/12 lg:h-full"
                        src={ heroimage } alt="" />
                    <img className="absolute top-[16%] right-[14%] sm:right-[14%] md:right-[24%] h-10 w-6 object-contain sm:h-10 animate-[wiggle_2s_ease-in-out_infinite] md:h-10 lg:w-10 lg:h-10"
                        src={ examIc } alt="" />
                    <img className="absolute z-20 top-[26%] left-[10%] sm:left-[10%] md:left-[0%] h-10 w-6 object-contain sm:h-10 animate-[wiggle_2s_ease-in-out_infinite] md:h-10 lg:w-10 lg:h-10"
                        src={ examnotification } alt="" />
                    <img className="absolute z-20 bottom-[4%] sm:bottom-[4%] md:bottom-[10%] right-[40%] h-10 w-6 object-contain sm:h-10 animate-[wiggle_2s_ease-in-out_infinite] md:h-10 lg:w-10 lg:h-10"
                        src={ algebraic } alt="" />
                </div>
            </div>
                                                ...
                                                <div className="bg-cover bg-center h-56 p-4"
                                                    ...
                                                    <div className="flex justify-end">
                                                        <div className='rounded-full text-red-500 bg-red-50 bg-opacity-80 p-2'>
                                                            <svg className="h-6 w-6 rounded-full text-red-500 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <div className='grid-cols-1 relative grid justify-center items-center gap-4 lg:grid-cols-2'>
                <div className='text-left md:ml-36 px-8'>
                    <h3 className='text-3xl font-bold '>Why Tathagat ?</h3>
                    <p className='text-xl text-gray-400 mt-4 tracking-wider md:w-full  '>
                        TATHAGAT = PERSONALIZED ATTENTION (LIMITED STUDENTS)+ALL SENIOR CAT TRAINERS +CURRICULUM TUNED TO MAJOR MBA ENTRANCE EXAMS.
                    </p>
                    <div className="mt-10 lg:mt-10 sm:mt-8 relative sm:flex sm:justify-center w-full sm:w-full md:w-2/3 lg:justify-start">
                        <input type='search' placeholder='Search your favourite course'
                ...
                <div className='flex-col sm:flex-col text-left p-8 flex lg:flex-row md:flex-row flex-wrap gap-10'>
                    <div className='w-full sm:w-full md:w-2/5 lg:w-2/5 h-full bg-[#e4feef] shadow-md text-gray-600 font-medium p-4 rounded-xl'>
                        <FaChalkboardTeacher className='h-12 w-12 mb-4 rounded-md bg-[#1fd56b] p-2 text-white' />
                        <h2 className='text-md font-semibold text-slate-800 mt-8'>Learn from the best</h2>
                        <p className='text-sm mt-2 tracking-wide mb-6 '>Learn from the masters of the subject, in the most engaging yet simplified ways</p>
                    </div>
                    <div className='w-full sm:w-full md:w-2/5 lg:w-2/5 h-full bg-[#ff44ad1f] shadow-md text-gray-600 font-medium p-4 rounded-xl md:mt-6'>
                        <FiVideo className='h-12 w-12 mb-4 rounded-md bg-[#ff44ad] p-2 text-white' />
                        <h2 className='text-md font-semibold text-slate-800 mt-8'>Live Tests for Real Exam Experience</h2>
                        <p className='text-sm mt-2 tracking-wide mb-6 '>Feel the thrill of a real exam. Improve your time & pressure management skills</p>
                    </div>
                    <div className='w-full sm:w-full md:w-2/5 lg:w-2/5 h-full md:-mt-8 bg-[rgba(255,203,0,.1)] shadow-md text-gray-600 font-medium p-4 rounded-xl'>
                        <FiBarChart2 className='h-12 w-12 mb-4 rounded-md bg-[rgba(255,203,0)] p-2 text-white' />
                        <h2 className='text-md font-semibold text-slate-800 mt-8'>Detailed Score Analysis</h2>
                        <p className='text-sm mt-2 tracking-wide mb-6 '>Get a detailed breakdown of your strengths & weaknesses and discover insights to improve your score</p>
                    </div>
                    <div className='w-full sm:w-full md:w-2/5 lg:w-2/5 h-full bg-[#f3f0ff] shadow-md text-gray-600 font-medium p-4 rounded-xl md:mt-6 '>
                        <FaLanguage className='h-12 w-12 mb-4 rounded-md bg-[#9775fa] p-2 text-white' />
                        <h2 className='text-md font-semibold text-slate-800 mt-8'>Multilingual: 2 Languages</h2>
                        <p className='text-sm mt-2 tracking-wide mb-6 '>Learn in the language you are most comfortable with. Choose from any of our 2 languages</p>
                    </div>
                </div>
            </div>
