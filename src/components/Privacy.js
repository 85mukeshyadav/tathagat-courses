					...
					<header>
						<div class="text-area">
							...
							<p align="justify">
								...
								<br />
								Tathagat Tutorials Private Limited has created this privacy
								policy in order to demonstrate own organization commitment to
								privacy. Throughout the cyberspace we want to contribute towards
								providing a safe and secure environment, safe information
								gathering and dissemination practices for all our sites. This
								policy applies to tathagat.co.in
								<br />
								<br />
								...
								within our various services. Personal information that you
								provide to other sites may be sent to our Website and/or App in
								order to deliver the service. We process such information under
								this Privacy Policy.
								<br />
								<br />
								<strong>6. Feedback </strong>
								<br />
								Tathagat Tutorials Private Limited Feedback Form requires
								personal information of users like contact number, name and
								e-mail address and demographic information like their zip code,
								age etc. for any feedback by the users pertaining to the
								services rendered by Tathagat Tutorials Private Limited.
								<br />
								<br />
